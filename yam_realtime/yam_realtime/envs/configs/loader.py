...
class DictLoader:
    ...
    @staticmethod
    def load(filenames: Union[str, List[str]], keys: Union[None, str, Tuple[str, ...]] = None, base_dir: str = None) -> Any:
        loaded = DictLoader._load(filenames, keys, base_dir)
    ...
    @staticmethod
    def _load(filenames: Union[str, List[str]], keys: Union[None, str, Tuple[str, ...]] = None, base_dir: str = None) -> Any:
        """
        ...
        if isinstance(filenames, str):
            ...
            if not os.path.isabs(filename) and base_dir is not None:
            ...
            for filename in filenames:
                cfg = DictLoader._load(filename, None, base_dir)
