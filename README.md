...
## Gello Configuration
Everything for gello is located in `teleop_and_inference`.
```
cd teleop_and_inference
```
...
storage:
  episodes: 50
  base_dir: "/home/prior/thomas/YAM/teleop_and_inference/data"
...
policy:
  ...
  repo_id: "/home/prior/thomas/YAM/datasets/yam_fold_towel_dp_dataset_v3_test"
