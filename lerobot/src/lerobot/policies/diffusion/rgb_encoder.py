...
class DiffusionRgbEncoder(nn.Module):
    ...
    def __init__(self, config: DiffusionConfig):
        ...
        # Set up backbone.
        backbone_model = getattr(torchvision.models, config.image_encoder_model_name)(
        ...
        dummy_shape_h_w = self.crop_shape if self.crop_shape is not None else images_shape[1:]
